...
cnn_shape('modelnet40v1', ...
  'expDir', fullfile(expDir,'modelnet40v1_netvlad'), ...
  'numFetchThreads', 12, ...
  'pad', 32, ...
  'border', 32, ...
  'netvlad', true, ...
  ...
  'maxIterPerEpoch', Inf, ...
  'numEpochs', [15 0 15], ...
  'learningRate', [0.05*ones(1,30)] ...
);  

% phase 2 -- Multi-view NetVLAD CNN
cnn_shape('modelnet40v1', ...
  'expDir', fullfile(expDir,'modelnet40v1_netvlad_mv'), ...
  'numFetchThreads', 12, ...
  'pad', 32, ...
  'border', 32, ...
  'netvlad', true, ...
  'netvladPos', 'conv5', ...
  'baseModel', fullfile(expDir,'modelnet40v1_netvlad','net-deployed.mat'), ...
  'multiview', true, ...
  'viewpoolPos', 'postL2', ...
  'batchSize', 5, ...
  'gpus', [1], ...
